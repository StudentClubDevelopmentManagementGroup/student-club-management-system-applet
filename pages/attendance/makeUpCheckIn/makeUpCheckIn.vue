<template>
	<view class="container">
		...
		<!-- 第二部分：展示考勤记录 -->
		<scroll-view class="attendance-list" style="background-image: url('/static/images/背景.jpg');" scroll-y
			:scroll-with-animation="true" @scrolltolower="loadMoreRecords">
